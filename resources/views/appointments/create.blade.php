...
@section('page_subtitle', 'Schedule a new patient appointment, assign a doctor, and capture service notes.')
        ...
        <form method="POST" action="{{ route('appointments.store') }}">
            ...
            <div class="form-grid">
                <div class="field">
                    ...
                    <select id="patient_id" name="patient_id" required>
                        ...
                        @foreach($patients as $patient)
                            <option value="{{ $patient->id }}" {{ old('patient_id') == $patient->id ? 'selected' : '' }}>{{ $patient->mrn }} - {{ $patient->full_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="field">
                ...
                <div class="field">
                    ...
                    <input id="service_type" name="service_type" value="{{ old('service_type') }}">
                </div>
                <div class="field">
                ...
                <div class="field">
                    ...
                    <input id="duration" type="number" name="duration" value="{{ old('duration', 30) }}" min="5" max="240" required>
                </div>

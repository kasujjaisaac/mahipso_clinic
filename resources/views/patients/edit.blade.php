...
@section('page_title', 'Edit ' . $patient->full_name)
@section('page_subtitle', 'Update registration details, demographics, and patient status.')
    ...
    <div class="panel">
        <form method="POST" action="{{ route('patients.update', $patient) }}">
            ...
            <div class="form-section" style="margin-bottom: 2rem;">
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <select id="branch_id" name="branch_id" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                            @foreach($branches as $branch)
                                <option value="{{ $branch->id }}" {{ old('branch_id', $patient->branch_id) == $branch->id ? 'selected' : '' }}>{{ $branch->name }} ({{ $branch->code }})</option>
                            @endforeach
                        </select>
                        @error('branch_id')
                    ...
                    <div class="field">
                        ...
                        <input id="mrn" name="mrn" value="{{ old('mrn', $patient->mrn) }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('mrn')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input id="first_name" name="first_name" value="{{ old('first_name', $patient->first_name) }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('first_name')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input id="last_name" name="last_name" value="{{ old('last_name', $patient->last_name) }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('last_name')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="form-section" style="margin-bottom: 2rem;">
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input id="phone" name="phone" value="{{ old('phone', $patient->phone) }}" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('phone')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', $patient->email) }}" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('email')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="field field-span-2">
                        ...
                        <textarea id="address" name="address" rows="3" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem; resize: vertical;">{{ old('address', $patient->address) }}</textarea>
                        @error('address')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="form-section" style="margin-bottom: 2rem;">
                ...
                <div class="form-grid">
                    <div class="field">
                        ...
                        <input id="national_id" name="national_id" value="{{ old('national_id', $patient->national_id) }}" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                        @error('national_id')
                            <p style="color: #ef4444; font-size: 0.8rem; margin: 0.25rem 0 0 0;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input id="insurance_provider" name="insurance_provider" value="{{ old('insurance_provider', $patient->insurance_provider) }}" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
                    ...
                    <div class="field">
                        ...
                        <input id="insurance_number" name="insurance_number" value="{{ old('insurance_number', $patient->insurance_number) }}" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 6px; font-size: 0.9rem;">
            ...
            <div class="action-stack" style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb; display: flex; gap: 1rem; justify-content: flex-end;">
                ...
                <button class="primary-button" type="submit" style="padding: 0.75rem 1.5rem;">Update Patient</button>
            </div>
        </form>
    </div>

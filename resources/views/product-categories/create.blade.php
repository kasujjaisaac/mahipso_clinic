...
<div class="container-fluid ps-5 pe-5 pt-4">
    <div class="mb-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 style="font-size: 28px; font-weight: 700; color: #222; margin: 0; font-family: 'Poppins';">+ Add Category</h1>
                <p style="color: #888; font-size: 12px; margin: 4px 0 0 0;">{{ $pharmacy->branch->name ?? 'Pharmacy' }} • Create new category</p>
            </div>
    ...
    <div style="background: #fff; border: 1px solid #f0d4d1; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 24px;">
            ...
            <form method="POST" action="{{ route('pharmacies.categories.store', $pharmacy) }}">
                @csrf
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    <textarea name="description" style="border: 1px solid #f0d4d1; border-radius: 0; padding: 8px 10px; width: 100%; font-size: 12px; font-family: inherit;" rows="4">{{ old('description') }}</textarea>
                </div>

                <div style="display: flex; gap: 12px; border-top: 1px solid #f0d4d1; padding-top: 16px;">
                    <button type="submit" style="background: #b8342b; color: white; padding: 10px 20px; font-size: 12px; font-weight: 600; border: none; cursor: pointer;\">+ Create Category</button>
